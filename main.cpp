...
void front()
{
	...
	output(250,650,"                  BMS INSTITUTE OF TECHNOLOGY",fonts[2]);
	...
	output(250,350,"1] JYOTHI R KAMATI",fonts[2]);
	output(650,350,"3]  MANASA M",fonts[2]);
	output(450,350,"2] K DEEVENA KUMARI",fonts[2]);
